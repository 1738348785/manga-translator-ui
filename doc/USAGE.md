...
2. 首次使用推荐选择：
   ...
   - **OpenAI**、**Gemini** 或 **Vertex**（纯文本翻译，需配置 API）
...
> - Vertex 系列使用固定官方 Gemini host，只需配置 `VERTEX_API_KEY` 和 `VERTEX_MODEL`
...
| **OpenAI** | GPT 系列模型 | 💰💰 | ★★★★ | ⭐ 简单 |
| **Gemini** | Google AI | 💰 | ★★★★ | ⭐ 简单 |
| **Vertex** | Google 官方 Gemini host，独立 `VERTEX_*` 配置 | 💰 | ★★★★ | ⭐ 简单 |
| **Sakura** | 日语优化 | 💰 | ★★★★ | ⭐⭐ 中等 |
...
| **高质量翻译 Vertex** | Gemini | 📸 看图翻译，独立管理 Google 官方 Key | ⭐⭐⭐⭐⭐ |
| **OpenAI** | GPT-4o | 纯文本翻译 | ⭐⭐⭐⭐ |
| **Gemini** | Gemini | 纯文本翻译 | ⭐⭐⭐⭐ |
| **Vertex** | Gemini | 纯文本翻译，固定官方 Gemini host | ⭐⭐⭐⭐ |
